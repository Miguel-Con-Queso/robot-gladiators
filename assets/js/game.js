...
var endGame = function() {
  ...
  // if player has more money than the high score, player has new high score
    if (playerInfo.money > highScore) {
      ...
      alert(playerInfo.name + " surprisingly beat the current high score. Their new high score is " + playerInfo.money);
    }
    else {
      alert(playerInfo.name + " sucks and did not beat the current high score of " + highScore + ". Hahaha, what a loser.");
    }
